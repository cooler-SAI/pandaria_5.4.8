-- Change realmlist table struct
ALTER TABLE `realmlist` 
DROP COLUMN `project_shortname`,
DROP COLUMN `color`,
DROP COLUMN `project_hidden`,
DROP COLUMN `project_enabled`,
DROP COLUMN `project_dbname`,
DROP COLUMN `project_dbworld`,
DROP COLUMN `project_dbarchive`,
DROP COLUMN `project_rates_min`,
DROP COLUMN `project_rates_max`,
DROP COLUMN `project_transfer_level_max`,
DROP COLUMN `project_transfer_items`,
DROP COLUMN `project_transfer_skills_spells`,
DROP COLUMN `project_transfer_glyphs`,
DROP COLUMN `project_transfer_achievements`,
DROP COLUMN `project_server_same`,
DROP COLUMN `project_server_settings`,
DROP COLUMN `project_server_remote_path`,
DROP COLUMN `project_accounts_detach`,
DROP COLUMN `project_setskills_value_max`,
DROP COLUMN `project_chat_enabled`,
DROP COLUMN `project_statistics_enabled`,
MODIFY COLUMN `address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '127.0.0.1' AFTER `name`,
ADD COLUMN `localAddress` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '127.0.0.1' AFTER `address`,
ADD COLUMN `localSubnetMask` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '255.255.255.0' AFTER `localAddress`,
MODIFY COLUMN `port` smallint NOT NULL DEFAULT 8085 AFTER `address`,
MODIFY COLUMN `flag` tinyint NOT NULL AFTER `icon`;
