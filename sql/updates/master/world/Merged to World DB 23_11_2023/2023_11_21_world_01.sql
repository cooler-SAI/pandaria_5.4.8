...
UPDATE `quest_template` SET `OfferRewardText`='$n! I wondered when I would see you again!$B$BWell, the plus side is that finding Wugou, the spirit of earth, was easy enough. Waking him... not so much. I think he\'s going to wake quite sore from all the pushing and hitting I\'ve done trying to rouse him.' WHERE `Id`=29680;
