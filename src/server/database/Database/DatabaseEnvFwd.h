...
using ArchiveDatabasePreparedStatement = PreparedStatement<ArchiveDatabaseConnection>;
...
using ArchiveDatabaseTransaction = SQLTransaction<ArchiveDatabaseConnection>;
...
using ArchiveDatabaseQueryHolder = SQLQueryHolder<ArchiveDatabaseConnection>;
