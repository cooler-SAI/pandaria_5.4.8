...
enum Spells
{
    ...
    SPELL_SHADOW_CONDUCTOR_AOE           = 92051,
...
class npc_golem_sentry : public CreatureScript
{
    public:
        ...
        {
            npc_golem_sentryAI(Creature* creature) : ScriptedAI(creature), summons(me)
            {
        ...
        {
            return GetInstanceAI<npc_golem_sentryAI>(creature);
        }
};
...
class npc_flash_bomb : public CreatureScript
{
    public:
        ...
        struct npc_flash_bombAI : public ScriptedAI
        {
            npc_flash_bombAI(Creature* creature) : ScriptedAI(creature)
            {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_flash_bombAI>(creature);
        }
};
...
class npc_laser_strike : public CreatureScript
{
    public:
        ...
        struct npc_laser_strikeAI : public ScriptedAI
        {
            npc_laser_strikeAI(Creature* creature) : ScriptedAI(creature)
            {
                SetCombatMovement(false);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_laser_strikeAI>(creature);
        }
};
...
class npc_drakonid_drudge : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_drakonid_drudgeAI>(creature);
        }
};
...
class npc_drakonid_chainwielder : public CreatureScript
{
    public:
        ...
        {
            npc_drakonid_chainwielderAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_drakonid_chainwielderAI>(creature);
        }
};
...
class npc_maimgor: public CreatureScript
{
    public:
        ...
        {
            npc_maimgorAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_maimgorAI>(creature);
        }
};
...
class npc_ivoroc: public CreatureScript
{
    public:
        ...
        {
            npc_ivorocAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_ivorocAI>(creature);
        }
};
...
class npc_pyreclaw: public CreatureScript
{
    public:
        ...
        {
            npc_pyreclawAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_pyreclawAI>(creature);
        }
};
...
class npc_drakonid_slayer: public CreatureScript
{
    public:
        ...
        {
            npc_drakonid_slayerAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_drakonid_slayerAI>(creature);
        }
};
...
class npc_drakeadon_mongrel: public CreatureScript
{
    public:
        ...
        {
            npc_drakeadon_mongrelAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_drakeadon_mongrelAI>(creature);
        }
};
...
class npc_bd_spirit_of_dwarf: public CreatureScript
{
    public:
        ...
        {
            npc_bd_spirit_of_dwarfAI(Creature* creature) : ScriptedAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_bd_spirit_of_dwarfAI>(creature);
        }
};
...
class npc_lord_victor_nefarius_heroic : public CreatureScript
{
    public:
        ...
        struct npc_lord_victor_nefarius_heroicAI : public ScriptedAI
        {
            npc_lord_victor_nefarius_heroicAI(Creature* creature) : ScriptedAI(creature), summons(me)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SHADOW_INFUSION:
                            ...
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 0.0f, true, SPELL_LIGHTNING_CONDUCTOR))
                            {
                                target->RemoveAurasDueToSpell(SPELL_LIGHTNING_CONDUCTOR);
                                me->AddAura(SPELL_SHADOW_CONDUCTOR, target);
                            }
                            break;
                        ...
                        case EVENT_ENCASING_SHADOWS:
                            ...
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 0.0f, true, SPELL_ACQUIRING_TARGET))
                                me->AddAura(SPELL_ENCASING_SHADOWS, target);
                            break;
                        case EVENT_JUMP_TO:
                        ...
                        case EVENT_BLAZING_INFERNO:
                            if (Creature* pMagmaw = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_MAGMAW)))
                            {
                                ...
                                if (!target)
                                    target = pMagmaw->AI()->SelectTarget(SELECT_TARGET_RANDOM, 0);
                                if (!target)
                                    return;
                                DoCast(target, SPELL_BLAZING_INFERNO_M);
                        ...
                        case EVENT_SHADOW_BREATH:
                            if (Creature* pMagmaw = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_MAGMAW)))
                            {
                                ...
                                if (!target)
                                    return;
                                DoCast(target, SPELL_SHADOW_BREATH);
                            }
                            events.ScheduleEvent(EVENT_SHADOW_BREATH, 4000);
                            break;
                        ...
                        case EVENT_MALORIAK_DARK_MAGIC:
                            if (GameObject* go = me->FindNearestGameObject(203306, 300.0f))
                                me->CastSpell(go, 92831, false);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_lord_victor_nefarius_heroicAI>(creature);
        }
};
...
class npc_blazing_bone_construct : public CreatureScript
{
    public:
        ...
        struct npc_blazing_bone_constructAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                if (instance->GetBossState(DATA_MAGMAW) != IN_PROGRESS)
                    me->DespawnOrUnsummon();
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetInstanceAI<npc_blazing_bone_constructAI>(creature);
        }
};
