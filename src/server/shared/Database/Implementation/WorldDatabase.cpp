...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    //PrepareStatement(WORLD_SEL_CREATURE_TEXT, "SELECT entry, text_group, id, text, type, language, probability, emote, duration, sound, text_female, text_range FROM creature_text", CONNECTION_SYNCH);
