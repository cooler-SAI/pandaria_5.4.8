...
enum QuestObjectiveType
{
    ...
    QUEST_OBJECTIVE_TYPE_FACTION_REP_NEG  = 7,
...
{
    QuestObjective(uint32 id, uint32 questID, uint8 index, uint8 type, uint32 objectId, int32 amount, uint32 flags, std::string description)
