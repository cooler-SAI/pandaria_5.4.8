...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_NEXT_SEAT, 0x0141, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleChangeSeatsOnControlledVehicle); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_PREV_SEAT, 0x03C4, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleChangeSeatsOnControlledVehicle); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TUTORIAL_CLEAR, 0x0F23, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialClear);
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CANCEL_COMBAT, 0x0534, STATUS_NEVER); // 5.4.8 18414  0x0E8B, skyfire is 0x0534
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT, 0x0C8A, STATUS_NEVER); // 5.4.8 18414 not in skyfire
    ...
    DEFINE_OPCODE_HANDLER(SMSG_HEALTH_UPDATE, 0x148B, STATUS_NEVER); // 5.4.8 18414 from skyfire
    ...
    DEFINE_OPCODE_HANDLER(SMSG_READ_ITEM_RESULT_FAILED, 0x0E8B, STATUS_NEVER); // 5.4.8 18414 skyfire version
