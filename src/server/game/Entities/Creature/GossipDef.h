...
enum Gossip_Option
{
    ...
    GOSSIP_OPTION_UNLEARN_SPEC           = 16,                   //UNIT_NPC_FLAG_GOSSIP              (1) (bonus option for GOSSIP_OPTION_TRAINER)
    GOSSIP_OPTION_UNLEARNTALENTS         = 17,                   //UNIT_NPC_FLAG_GOSSIP              (1) (bonus option for GOSSIP_OPTION_TRAINER)
    GOSSIP_OPTION_UNLEARN_GLYPHS         = 18,                   //UNIT_NPC_FLAG_GOSSIP              (1) (bonus option for GOSSIP_OPTION_TRAINER)
